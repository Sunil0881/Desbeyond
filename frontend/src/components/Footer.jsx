    ...
    return (
        <div>
            ...
            <div className='md:grid md:grid-cols-5 '>
                <div className='pl-8'>
                    <h1 className='md:text-2xl text-white font-bold'>DESBEYOND</h1>
                    <h1 className='md:text-md text-white font-seminormal '>Design Beyond</h1>
                </div>
                <div>

                </div>
                <div></div>
                <div className='block text-white pl-8'>
