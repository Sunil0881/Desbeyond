...
const Service = () => {
  return (
    <div className="text-white font-poppins overflow-x-hidden">
      <Navbar />
      <h1 className="text-3xl md:text-5xl font-bold text-center my-5 md:my-24 text-gray-800" data-aos="fade-down">
        Services We Provide
      </h1>
      ...
      <div>
        <div className="text-2xl md:text-3xl text-center py-5 underline font-bold">
          OUR PRIMARY SERVICES
        </div>
        <div className="md:text-5xl text-2xl md:my-5 my-2 font-semibold mx-5 list-none">
          <li className="md:my-20 my-10">1) Interior Typeset Book Designs</li>
          <li className="md:my-20 my-10">2) Book Cover Wrapper Design Services</li>
          <li className="md:my-20 my-10">3) E-Book Designs</li>
        </div>
      </div>
      <div>
