              ...
              <form ref={form} onSubmit={sendEmail}>
                ...
                <div class=" mb-6" data-te-input-wrapper-init>
                  <label for="exampleFormControlTextarea1"
                    ...
                    class="peer block min-h-[auto] w-full rounded-lg border-black border-2 bg-transparent py-[0.32rem] px-3 leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-neutral-200 dark:placeholder:text-neutral-200 [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0"
